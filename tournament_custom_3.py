...
def main():
    ...
    #               Agent(CustomPlayer(score_fn=custom_score_1, **CUSTOM_ARGS), "Student1"),
    #               Agent(CustomPlayer(score_fn=custom_score_2, **CUSTOM_ARGS), "Student2"),
    #               Agent(CustomPlayer(score_fn=custom_score_3, **CUSTOM_ARGS), "Student3")]
    test_agents = [Agent(CustomPlayer(score_fn=custom_score_3, **CUSTOM_ARGS), "Student3")]
